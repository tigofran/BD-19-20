...
insert into proposta_de_correcao(email,data_hora,texto) values ('jose@gmail.com','2019-08-08 10:00:00','Escrever steel em vez de steal');
insert into proposta_de_correcao(email,data_hora,texto) values ('manel@gmail.com','2019-10-02 07:15:00','Escrever montanha');
insert into proposta_de_correcao(email,data_hora,texto) values ('alexandra@gmail.com','2019-06-08 13:00:00','Colocar acento no O');
insert into proposta_de_correcao(email,data_hora,texto) values ('miguel@gmail.com','2019-11-11 19:45:33','Escrever steel em vez de steal');
insert into proposta_de_correcao(email,data_hora,texto) values ('jose@gmail.com','2019-12-25 01:01:01','Mais correto usar o termo lapiseira');
insert into proposta_de_correcao(email,data_hora,texto) values ('miguel@gmail.com','2019-11-04 12:00:00','Escrever Portugal');

insert into correcao(email,nro,anomalia_id) values ('jose@gmail.com',1,6);
insert into correcao(email,nro,anomalia_id) values ('manel@gmail.com',2,7);
insert into correcao(email,nro,anomalia_id) values ('alexandra@gmail.com',3,2);
insert into correcao(email,nro,anomalia_id) values ('miguel@gmail.com',4,6);
insert into correcao(email,nro,anomalia_id) values ('jose@gmail.com',5,3);
insert into correcao(email,nro,anomalia_id) values ('miguel@gmail.com',6,5);
